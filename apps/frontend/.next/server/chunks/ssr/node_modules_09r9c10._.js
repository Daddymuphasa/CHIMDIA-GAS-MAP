module.exports = [
  ...
  (a, b, c) => {
    ...
    let f = 'text/plain',
      ...
      S = 'private-next-rsc-server-reference',
      T = 'private-next-rsc-cache-wrapper',
      U = 'private-next-rsc-track-dynamic-import',
      V = 'private-next-rsc-action-encryption',
      ...
      ah = ['app', 'pages', 'components', 'lib', 'src'],
      ai = { edge: 'edge', experimentalEdge: 'experimental-edge', nodejs: 'nodejs' },
      aj = 12,
      ak = {
        shared: 'shared',
      ...
      al = {
        ...
        GROUP: {
          ...
          bundled: [
            ak.reactServerComponents,
            ak.actionBrowser,
            ak.serverSideRendering,
            ak.appPagesBrowser,
            ak.shared,
            ak.instrument,
            ak.middleware,
  ...
  (a, b, c) => {
    ...
    function e(a) {
      let [b, c, e, f] = a,
        { layout: g, template: h } = e,
        { page: i } = e;
      i = b === d.DEFAULT_SEGMENT_KEY ? e.defaultPage : i;
      let j = g?.[1] || h?.[1] || i?.[1];
      return {
        page: i,
        segment: b,
      ...
      parseAppRoute: function () {
        return function a(b, c) {
          ...
          for (let l of j) {
            let j = i(
              (function (a) {
                ...
                try {
                  ...
                  return (0, g.getSegmentParam)(b) ? b : a;
                } catch {
                  return a;
                }
              })(l)
            ...
            if (j) {
              if (c && ('route-group' === j.type || 'parallel-route' === j.type))
                throw Object.defineProperty(
              ...
              if ((k.push(j), j.interceptionMarker)) {
                let f = b.split(j.interceptionMarker);
                if (2 !== f.length)
                  throw Object.defineProperty(
  ...
  (a, b, c) => {
    ...
    function j(a, b, c, d) {
      ...
      for (; j.length > 0; ) {
        ...
        let n = b;
        for (let a of (m && 'route-group' !== m.type && 'parallel-route' !== m.type && n++,
        Object.values(l)))
    ...
    function k(a, b, c, d, e) {
      ...
      if (!g || 0 === g.length) {
        if ('oc' === c) return { param: b, value: null, type: c, treeSegment: [b, '', c, e] };
        throw Object.defineProperty(
          new f.InvariantError(
      ...
      let h = Array.isArray(g) ? g.join('/') : g;
      return { param: b, value: g, treeSegment: [b, h, c, e], type: c };
    }
    let l = /^([^[]*)\[((?:\[[^\]]*\])|[^\]]+)\](.*)$/;
    function m(a) {
      let b = a.match(l);
  ...
  (a, b, c) => {
    ...
    function m({
      ...
      let p = n in d;
      e ? (d[n] = `${e}${i}`) : (d[n] = i);
      let q = a ? (0, h.escapeStringRegexp)(a) : '';
      return (
        (g = p && f ? `\\k<${n}>` : l ? `(?<${n}>.+?)` : `(?<${n}>[^/]+?)`),
        {
          key: i,
  ...
  (a, b, c) => {
    ...
    async function o(a, b) {
      ...
      if (!a.getInitialProps)
        return b.ctx && b.Component ? { pageProps: await o(b.Component, b.ctx) } : {};
    ...
    function e(a, b, c = !0) {
      let f = new URL('http://n'),
        g = b ? new URL(b, f) : a.startsWith('.') ? new URL('http://n') : f,
        {
          ...
          href: l,
          origin: m,
        } = a.startsWith('/') ? new URL(`${g.protocol}//${g.host}${a}`) : new URL(a, g);
      if (m !== f.origin)
        throw Object.defineProperty(
  ...
  (a, b, c) => {
    ...
    function n(a) {
      ...
      let l = c.origin;
      return (
        l && (l = k(l)), { ...c, pathname: d, hostname: h, href: e, hash: i, search: j, origin: l }
      );
    }
    function o(a) {
      let b,
      ...
      return (
        (d.query = { ...a.query, ...d.query }), { newUrl: c, destQuery: f, parsedDestination: d }
      );
    }
  },
  92273,
  ...
  (a, b, c) => {
    ...
    let f = 'rsc',
      ...
      m = 'next-url',
      n = 'text/x-component',
      o = 'next-instant-navigation-testing-prefetch',
      p = 'next-instant-navigation-testing',
      q = [f, h, i, k, j],
      r = '_rsc',
      s = 'x-nextjs-stale-time',
      t = 'x-nextjs-postponed',
      u = 'x-nextjs-rewritten-path',
      v = 'x-nextjs-rewritten-query',
      w = 'x-nextjs-prerender',
      x = 'x-nextjs-action-not-found',
      y = 'x-nextjs-request-id',
      z = 'x-nextjs-html-request-id',
      A = 'x-action-revalidated';
  ...
  (a, b, c) => {
    ...
    function u(a, b, c, d) {
      let e = (a, b) => {
          if (!a) return !1;
          let c = (0, l.normalizeRscURL)(a);
          for (let a = 0; a < 3; a++) {
            if (c === b) return !0;
            let a = (0, o.decodeQueryPathParameter)(c);
            if (a === c) break;
            c = a;
          }
          return !1;
        ...
        f = {};
      for (let g of Object.keys(b.groups)) {
        let h = a[g];
        'string' == typeof h
          ? (h = (0, l.normalizeRscURL)(h))
          : Array.isArray(h) && (h = h.map(l.normalizeRscURL));
        let i = c[g],
          j = b.groups[g].optional;
        if (
          (Array.isArray(i)
            ? i.some((a) => (Array.isArray(h) ? h.some((b) => e(b, a)) : e(h, a)))
            : Array.isArray(h)
            ? h.some((a) => e(a, i))
            : e(h, i)) ||
          (void 0 === h && !(j && d))
        ...
        j &&
          (!h ||
            (Array.isArray(h) && 1 === h.length && ('index' === h[0] || h[0] === `[[...${g}]]`)) ||
            'index' === h ||
            h === `[[...${g}]]`) &&
          ((h = void 0), delete a[g]),
          h && 'string' == typeof h && b.groups[g].repeat && (h = h.split('/')),
          h && (f[g] = h);
      }
      return { params: f, hasValidParams: !0 };
    }
    function v({
      page: a,
      i18n: b,
      ...
      return (
          ...
          (w = (q = (0, i.getRouteMatcher)(p))(a))),
        {
          ...
          normalizeDynamicRouteParams: (a, b) =>
            p && w ? u(a, p, w, b) : { params: {}, hasValidParams: !1 },
  ...
  (a, b, c) => {
    ...
    function p(a, b, c, d) {
      let e = (0, l.normalizeAppPath)(a),
        f = (0, j.getNamedRouteRegex)(e, { prefixRouteKeys: !1 }),
        g = d
          ? Object.keys(f.groups).reduce((a, b) => {
              let { repeat: c } = f.groups[b];
              return (a[b] = c ? ['-'] : '-'), a;
            }, {})
          : b,
        k = (0, i.interpolateDynamicPath)(e, g, f),
        { name: n, ext: p } = h.default.parse(c),
        q = o(h.default.posix.join(a, n)),
        r = q ? `-${q}` : '';
      return (0, m.normalizePathSep)(h.default.join(k, `${n}${r}${p}`));
    }
    function q(a) {
