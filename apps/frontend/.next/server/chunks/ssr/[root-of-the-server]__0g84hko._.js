module.exports = [
        ...
        x = {
          ...
          996: (a, b) => {
            ...
            Object.defineProperty(b, '__esModule', { value: !0 }),
              ...
              ((c = b.SamplingDecision || (b.SamplingDecision = {}))[(c.NOT_RECORD = 0)] =
                'NOT_RECORD'),
              (c[(c.RECORD = 1)] = 'RECORD'),
    ...
    let n = (a, b) => {
        m(b) && b.bubble
          ...
          : (b && (a.recordException(b), a.setAttribute('error.type', b.name)),
            a.setStatus({ code: i.ERROR, message: null == b ? void 0 : b.message })),
          a.end();
      },
      o = new Map(),
      ...
      s =
        ((c = new (class a {
          ...
          trace(...a) {
            let [b, c, g] = a,
              { fn: h, options: i } =
                'function' == typeof c ? { fn: c, options: {} } : { fn: g, options: { ...c } },
              j = i.spanName ?? b;
            if (
              (!d.NextVanillaSpanAllowlist.has(b) && '1' !== process.env.NEXT_OTEL_VERBOSE) ||
              i.hideSpan
            )
              return h();
            ...
            let m = l.getValue(p),
              ...
              s = q++;
            return (
              (i.attributes = { 'next.span_name': j, 'next.span_type': b, ...i.attributes }),
              f.with(l.setValue(p, s), () =>
                this.getTracerInstance().startActiveSpan(j, i, (a) => {
                  ...
                  if ((r && o.set(s, new Map(Object.entries(i.attributes ?? {}))), h.length > 1))
                    try {
                      return h(a, (b) => n(a, b));
                    } catch (b) {
                      throw (n(a, b), b);
          ...
          wrap(...a) {
            ...
            return d.NextVanillaSpanAllowlist.has(c) || '1' === process.env.NEXT_OTEL_VERBOSE
              ? function () {
                  let a = e;
                  'function' == typeof a &&
                    'function' == typeof g &&
                  ...
                  let d = arguments.length - 1,
                    h = arguments[d];
                  if ('function' != typeof h) return b.trace(c, a, () => g.apply(this, arguments));
                  {
  ...
  (a) => {
    'use strict';
    a.i(75164), Symbol('__next_preview_data');
    ...
    class g {
      ...
      redirect(a, b) {
        return (
          ...
          (this.statusCode = b),
          b === e.RedirectStatusCode.PermanentRedirect && this.setHeader('Refresh', `0;url=${a}`),
          this
        );
      }
    }
  ...
  (a) => {
    ...
    a.s([
      ...
      function (a) {
        ...
        return (c && (a = a.slice(c.length)), a.startsWith('[[...') && a.endsWith(']]'))
          ? { paramType: 'optional-catchall', paramName: a.slice(5, -2) }
          : a.startsWith('[...') && a.endsWith(']')
          ? { paramType: c ? `catchall-intercepted-${c}` : 'catchall', paramName: a.slice(4, -1) }
          : a.startsWith('[') && a.endsWith(']')
          ? { paramType: c ? `dynamic-intercepted-${c}` : 'dynamic', paramName: a.slice(1, -1) }
          : null;
      },
      'isCatchAll',
      0,
  ...
  (a) => {
      ...
      switch (c) {
        ...
        case 'dynamic-intercepted-(...)':
          if (d < e.segments.length) {
            let a = e.segments[d];
            if ('dynamic' === a.type && !f.hasOwnProperty(a.param.paramName)) return;
    ...
    function k(a) {
      ...
      let b = Math.random().toString(16).slice(2),
        c = new Map();
      for (let { paramName: d, paramType: e } of a) c.set(d, [`%%drp:${d}:${b}%%`, j[e]]);
      return c;
    }
    function l(a) {
      let { repeat: b, optional: d } = (0, c.getParamProperties)(a.paramType);
      return d ? `[[...${a.paramName}]]` : b ? `[...${a.paramName}]` : `[${a.paramName}]`;
    }
    a.s(
      [
        ...
        function (a, d) {
          let f = (function a(d, f) {
              ...
              for (let l of j) {
                ...
                if (j) {
                  if (f && ('route-group' === j.type || 'parallel-route' === j.type))
                    throw Object.defineProperty(
                      new b.InvariantError(
            ...
            { pathnameRouteParamSegments: h, params: j } = (function (a, b) {
              ...
              for (; f.length > 0; ) {
                  ...
                  if (h < b.segments.length) {
                    ...
                    if ('dynamic' === d.type) {
                      ...
                      (function (a, b) {
                        ...
                        return !0;
                      })(j, b) && c.push({ name: k, paramName: a, paramType: e });
                    }
                  }
                ...
                for (let a of Object.values(l)) f.push({ tree: a, depth: n, currentPath: m });
              }
              return { pathnameRouteParamSegments: c, params: d };
            })(d.userland.loaderTree, f),
            l = h.map(({ paramName: a, paramType: b }) => ({ paramName: a, paramType: b }));
          return (
            !(function (a, b, c, d) {
              ...
              for (; f.length > 0; ) {
                ...
                let m = h;
                for (let a of (l && 'route-group' !== l.type && 'parallel-route' !== l.type && m++,
                Object.values(k)))
        ...
        function (a, b) {
          return b.filter((b) => {
            ...
            return d === c || (Array.isArray(d) && 1 === d.length && d[0] === c);
          });
        },
      ],
      90588
  ...
  (a) => {
    ...
    a.s(['parsePath', 0, b], 38549),
      a.s(['pathHasPrefix', 0, c], 83838),
      a.s(
        [
          'removePathPrefix',
          0,
  ...
  (a) => {
    ...
    a.s([
      ...
      function (a, b) {
        ...
        if (g && !g[i(b)])
          return (
            (f = Object.keys(g)[0]), (0, c.normalizeAppPath)((0, e.removePathPrefix)(f, 'app'))
          );
      },
      'setManifestsSingleton',
      0,
      function ({ page: a, clientReferenceManifest: d, serverActionsManifest: e }) {
        let j = h[g],
          l = {
        ...
        if (j)
          j.clientReferenceManifestsPerRoute.set((0, c.normalizeAppPath)(a), d),
                  ...
                  get(a, c) {
                    ...
                    switch (c) {
                      ...
                      case 'entryJSFiles': {
                        if (!d)
                          throw Object.defineProperty(
                            new b.InvariantError(`Cannot access "${c}" without a work store.`),
                            '__NEXT_ERROR_CODE',
                          ...
                          ((a = new Proxy(
                            {},
                            {
                              get(a, b) {
                                ...
                                if (d) {
                                  let a = j.get(d.route);
                                  if (null == a ? void 0 : a[c][b]) return a[c][b];
                                } else
            ...
            serverModuleMap: new Proxy(
              {},
              {
                get: (a, b) => {
                  var c, d;
                  let e,
                    g = null == (d = k().node) || null == (c = d[b]) ? void 0 : c.workers;
                  if (!g) return;
  ...
  (a) => {
    ...
    function c(a) {
      ...
      a.headers instanceof Headers
        ? ((c = a.headers.get(b.ACTION_HEADER) ?? null), (d = a.headers.get('content-type')))
        : ((c = a.headers[b.ACTION_HEADER] ?? null), (d = a.headers['content-type'] ?? null));
  ...
  (a) => {
    ...
    function g(a, b) {
      ...
      if ('u' > typeof Buffer)
        return (Buffer.isBuffer(a) ? a : Buffer.from(a.buffer, a.byteOffset, a.byteLength)).indexOf(
          b
        );
    ...
    async function n(a, b, c, d) {
      let e =
        (void 0 === a || '0' === a) && void 0 === b && void 0 === c && void 0 === d
          ? null
    ...
    function w(a) {
      ...
      return new TransformStream({
        async transform(d, e) {
          ...
          let j = 0;
          if (-1 === h) {
            if (-1 === (h = g(d, f.ENCODED_TAGS.META.ICON_MARK))) return void e.enqueue(d);
            47 === d[h + (j = f.ENCODED_TAGS.META.ICON_MARK.length)] ? (j += 2) : j++;
          }
          if (0 === b) {
            if (((i = g(d, f.ENCODED_TAGS.CLOSED.HEAD)), -1 !== h)) {
              if (h < i) {
                ...
                f.set(d.subarray(0, h)), f.set(c, h), f.set(d.subarray(h + j), h + e), (d = f);
              }
              c = !0;
            }
          } else {
    ...
    function C() {
      ...
      return new TransformStream({
        transform(b, c) {
          ...
          if (d > -1) {
            if (((a = !0), b.length === f.ENCODED_TAGS.CLOSED.BODY_AND_HTML.length)) return;
            let e = b.slice(0, d);
            if ((c.enqueue(e), b.length > f.ENCODED_TAGS.CLOSED.BODY_AND_HTML.length + d)) {
      ...
      return new TransformStream({
        ...
        flush(c) {
          ...
          a || d.push('html'),
            ...
            <template
              data-next-error-message="Missing ${d
                .map((a) => `<${a}>`)
                .join(d.length > 1 ? ' and ' : '')} tags in the root layout.
Read more at https://nextjs.org/docs/messages/missing-root-layout-tags"
    ...
    async function H(
      a,
      { getServerInsertedHTML: b, getServerInsertedMetadata: c, deploymentId: d }
    ) {
      return F(a, [
        v(),
        new TransformStream({
    ...
    a.s(
      [
        ...
        function ({ ReactDOMServer: a, element: d, streamOptions: e }) {
          return (0, b.getTracer)().trace(c.AppRenderSpan.renderToReadableStream, async () =>
            a.renderToReadableStream(d, e)
          );
        },
        'streamFromBuffer',
        0,
  ...
  (a) => {
      ...
      analyze() {
        ...
        let g = (function (a, b) {
            let { basePath: c, i18n: d, trailingSlash: e } = b.nextConfig ?? {},
              g = { pathname: a, trailingSlash: '/' !== a ? a.endsWith('/') : e };
            c &&
              (0, f.pathHasPrefix)(g.pathname, c) &&
              ((g.pathname = (0, i.removePathPrefix)(g.pathname, c)), (g.basePath = c));
            let j = g.pathname;
            if (g.pathname.startsWith('/_next/data/') && g.pathname.endsWith('.json')) {
              let a = g.pathname
                .replace(/^\/_next\/data\//, '')
                .replace(/\.json$/, '')
                .split('/');
            ...
            if (d) {
              ...
              (g.locale = a.detectedLocale),
                ...
                !a.detectedLocale &&
                  g.buildId &&
                  (a = b.i18nProvider ? b.i18nProvider.analyze(j) : h(j, d.locales))
                    .detectedLocale &&
                  (g.locale = a.detectedLocale);
            }
            return g;
      ...
      formatPathname() {
        ...
        return (
          (c = (function (a, b, c, e) {
            ...
            let g = a.toLowerCase();
            return !e &&
              ((0, f.pathHasPrefix)(g, '/api') || (0, f.pathHasPrefix)(g, `/${b.toLowerCase()}`))
              ? a
              : d(a, `/${b}`);
          })(
            (a = {
          ...
          a.buildId &&
            (c = e(d(c, `/_next/data/${a.buildId}`), '/' === a.pathname ? 'index.json' : '.json')),
          (c = d(c, a.basePath)),
          !a.buildId && a.trailingSlash ? (c.endsWith('/') ? c : e(c, '/')) : b(c)
        );
      }
      formatSearch() {
    ...
    let s = 0,
      ...
      u = 0;
    function v(a) {
      return (null == a ? void 0 : a.name) === 'AbortError' || (null == a ? void 0 : a.name) === n;
    }
    ...
    a.s(['isAbortError', 0, v, 'pipeToNodeResponse', 0, w], 14976);
    var x = a.i(22693),
      y = a.i(85034);
    class z {
      static #a = (this.EMPTY = new z(null, { metadata: {}, contentType: null }));
  ...
  (a) => {
    'use strict';
    let { env: b, stdout: c } = (null == (u = globalThis) ? void 0 : u.process) ?? {},
      d =
        b &&
        !b.NO_COLOR &&
        (b.FORCE_COLOR || ((null == c ? void 0 : c.isTTY) && !b.CI && 'dumb' !== b.TERM)),
      e = (a, b, c, d) => {
    ...
    new o(1e4, (a) => a.length), a.s(['warn', 0, r, 'warnOnce', 0, t], 43070);
    var u,
      v = a.i(26026);
    class w {
      constructor(a, b = (a) => a()) {
      ...
      static create(a) {
        return new w(null == a ? void 0 : a.cacheKeyFn, null == a ? void 0 : a.schedulerFn);
      }
      async batch(a, b) {
      ...
      return {
        ...
        value:
          (null == (b = a.value) ? void 0 : b.kind) === y.CachedRouteKind.PAGES
            ...
            : (null == (c = a.value) ? void 0 : c.kind) === y.CachedRouteKind.APP_PAGE
            ? {
    ...
    class J {
      constructor(a, b = G, c = F) {
        (this.getBatcher = w.create({
          ...
          (this.revalidateBatcher = w.create({ schedulerFn: x.scheduleOnNextTick })),
      ...
      async get(a, b, c) {
        ...
        let {
          ...
          l = await this.getBatcher.batch({ key: a, isOnDemandRevalidate: e }, ({ resolve: c }) => {
  ...
  (a, b, c) => {
    (() => {
      ...
      (d.ab = '/ROOT/node_modules/next/dist/compiled/fresh/'), (b.exports = d(695));
    })();
  },
  10531,
  (a) => {
    ...
    function d(a, c, d) {
      return (
        ...
        !!(0, b.default)(a.headers, { etag: d }) && ((c.statusCode = 304), c.end(), !0)
      );
    }
    async function e({
      req: a,
      ...
      h && f.contentType === c.HTML_CONTENT_TYPE_HEADER && b.setHeader('X-Powered-By', 'Next.js'),
        i &&
    ...
    a.s(['sendEtagResponse', 0, d, 'sendRenderResult', 0, e], 10531);
  },
  1082,
  (a) => {
    'use strict';
  ...
  (a, b, c) => {
    let { createClientModuleProxy: d } = a.r(11857);
    a.n(d('[project]/node_modules/next/dist/esm/client/components/layout-router.js'));
  },
  28212,
  (a) => {
    'use strict';
  ...
  (a, b, c) => {
    let { createClientModuleProxy: d } = a.r(11857);
    a.n(
      d('[project]/node_modules/next/dist/esm/client/components/render-from-template-context.js')
    );
  },
  54691,
  (a) => {
  ...
  (a, b, c) => {
    let { createClientModuleProxy: d } = a.r(11857);
    a.n(
      d('[project]/node_modules/next/dist/esm/client/components/client-page.js <module evaluation>')
    );
  },
  92977,
  (a, b, c) => {
    let { createClientModuleProxy: d } = a.r(11857);
    a.n(d('[project]/node_modules/next/dist/esm/client/components/client-page.js'));
  },
  20575,
  (a) => {
    'use strict';
  ...
  (a, b, c) => {
    let { createClientModuleProxy: d } = a.r(11857);
    a.n(d('[project]/node_modules/next/dist/esm/client/components/client-segment.js'));
  },
  5476,
  (a) => {
    'use strict';
  ...
  (a) => {
    ...
    a.s(
      [
        ...
        0,
        function (a) {
          return !!(a && 'object' == typeof a && a instanceof Error && a.digest === d);
        },
      ],
      91191
    );
    ...
    a.s(
      [
        ...
        function (a, c) {
          ...
          if (a) for (let b of a) d.add(b.name), null !== b.value && f.set(b.name, b.value);
        ...
        function (a, b, c) {
          return new Proxy(a, {
            get: (a, d, e) => (
              'string' != typeof d || l.wellKnownProperties.has(d) || b.has(d) || n(p(c, d)),
              Reflect.get(a, d, e)
            ),
            has: (a, d) => (
              'string' != typeof d || l.wellKnownProperties.has(d) || b.has(d) || n(p(c, d)),
          ...
          return new Proxy(a, {
            get(a, d, e) {
              if ('get' === d || 'getAll' === d || 'has' === d) {
                ...
                return (d) => ('string' != typeof d || b.has(d) || n(p(c, d)), f.call(a, d));
              }
              let f = Reflect.get(a, d, e);
              return 'function' != typeof f || Object.hasOwn(a, d) ? f : f.bind(a);
            },
          });
        },
        ...
        function (a, b, c) {
          ...
          let e = new Set(),
            f = {};
          for (let [a, b] of d) e.add(a.toLowerCase()), null !== b && (f[a.toLowerCase()] = b);
        ...
        function (a, b, c) {
              ...
              for (let d of a.split('/')) {
                ...
                if (a)
                  switch (a.paramType) {
                    ...
                    case 'dynamic-intercepted-(...)':
                      throw Object.defineProperty(
                        new i.InvariantError('Not implemented: Validation of interception routes'),
                        '__NEXT_ERROR_CODE',
          ...
          return (function (a, b, c = !0) {
            let d = new URL('http://n'),
              e = b ? new URL(b, d) : a.startsWith('.') ? new URL('http://n') : d,
              {
                pathname: f,
                searchParams: g,
                search: h,
  ...
  (a, b, c) => {
    let { createClientModuleProxy: d } = a.r(11857);
    a.n(d('[project]/node_modules/next/dist/esm/lib/framework/boundary-components.js'));
  },
  82622,
  (a) => {
    'use strict';
  ...
  (a, b, c) => {
    let { createClientModuleProxy: d } = a.r(11857);
    a.n(d('[project]/node_modules/next/dist/esm/lib/metadata/generate/icon-mark.js'));
  },
  6983,
  (a) => {
    'use strict';
        ...
        d ||
          (a._closed
            ? a._allowPartialStream
              ? (((a = d = G()).status = 'halted'), (a.value = null), (a.reason = null))
    ...
    function am(a, b, c) {
      ...
      (g[r] = function () {
        ...
        aj(a, b, c ? g[r]() : g, {
          ...
          error: function (b) {
            if (!e) for (e = !0, f === d.length && (d[f] = G()); f < d.length; ) L(a, d[f++], b);
          },
        });
    }
    function an() {
    ...
    function aq(a, b, c, d, e) {
      switch (d) {
        case 73:
          ...
          } else j ? P(f, j, k) : ((j = new E('resolved_module', k, null)), i.set(g, j));
          break;
        case 72:
        ...
        case 69:
          ...
          var o = an();
          (o.digest = e.digest), d ? L(a, d, o) : ((a = new E('rejected', null, o)), b.set(c, a));
          break;
        case 84:
      ...
      for (
        ...
        if (-1 < l)
          ...
          (c = new Uint8Array(c.buffer, m, c.byteLength - d)),
            98 === h ? ((i -= c.byteLength), ai(a, g, c)) : (j.push(c), (i -= c.byteLength));
          break;
        }
      }
    ...
    function as(a, b) {
      return (function a(b, c, d, e) {
        ...
        if (s(c)) {
          ...
          return c[0] === o
            ? (c[0] === o
                ? ((b = { $$typeof: o, type: c[1], key: c[2], ref: null, props: c[3] }),
                  null !== Q &&
                    ((Q = (c = Q).parent),
                    c.errored
        ...
        ? ((a._closed = !0),
          a._chunks.forEach(function (a) {
            'pending' === a.status
              ...
              : 'fulfilled' === a.status && null !== a.reason && a.reason.close('"$undefined"');
          }))
        ...
        return (
          (d = b =
            new ag(
              ...
              void 0,
              !!c && !!c.unstable_allowPartialStream && c.unstable_allowPartialStream
            )),
          (e = at.bind(null, b)),
          (f = ah()),
  ...
  (a) => {
    ...
    function o(a, b, c) {
      ...
      let d = {};
      for (let c in b) Object.defineProperty(d, c, { get: () => (n(a, c), b[c]), enumerable: !0 });
      return d;
    }
    ...
    class r extends Error {
      constructor(a) {
        super(`Dynamic server usage: ${a}`), (this.description = a), (this.digest = q);
      }
    }
    function s(a) {
      return (
    ...
    a.s(['DynamicServerError', 0, r, 'isDynamicServerError', 0, s], 81793);
    ...
    function w(a, b, c) {
      ...
      throw (
        ((c.revalidate = 0), (b.dynamicUsageDescription = a), (b.dynamicUsageStack = d.stack), d)
      );
    }
    function x(a, b, c) {
      (function () {
              ...
              switch (b.type) {
                ...
                case 'prerender-client':
                  ...
                  let f = F(d.renderSignal, c.route, '`searchParams`'),
                    g = new Proxy(f, {
                      get(a, b, c) {
                        if (Object.hasOwn(f, b)) return p.ReflectAdapter.get(a, b, c);
                        switch (b) {
                          case 'then':
                            return (
                              A('`await searchParams`, `searchParams.then`, or similar', d),
                              p.ReflectAdapter.get(a, b, c)
                            );
                          case 'status':
                            return (
                              A('`use(searchParams)`, `searchParams.status`, or similar', d),
                              p.ReflectAdapter.get(a, b, c)
                            );
                          default:
                ...
                case 'prerender-legacy':
                  ...
                  let k = Promise.resolve({}),
                    l = new Proxy(k, {
                      get(a, b, c) {
                        if (Object.hasOwn(k, b)) return p.ReflectAdapter.get(a, b, c);
          ...
          case 'request':
            return (function (b, c, d, e) {
              ...
              if (d.validationSamples) {
                let { createExhaustiveSearchParamsProxy: e } = a.r(39783),
                  ...
                  for (let b in h)
                    if (a.has(b))
                      return (function (a, b, c) {
                        let d = T.get(a);
                        if (d) return d;
                        let e = new Proxy(F(c.renderSignal, b.route, '`params`'), U);
                        return T.set(a, e), e;
                      })(p, j, m);
                }
                break;
                            ...
                            L.wellKnownProperties.has(a) ||
                              (b.has(a) &&
                                Object.defineProperty(f, a, {
                                  get() {
                                    let b = (0, L.describeStringPropertyAccess)('params', a);
          ...
          case 'request':
            if (g.asyncApiPromises && g.validationSamples)
              return (function (b, c, d, e, f) {
                let { createExhaustiveParamsProxy: g } = a.r(39783),
                  h = g(b, new Set(Object.keys(d.params ?? {})), c.route);
                return (f ? e.earlySharedParamsParent : e.sharedParamsParent).then(() => h);
      ...
      a.s(
        [
          ...
          function (a) {
            ...
            if (!b)
              throw Object.defineProperty(
                new B.InvariantError('Missing workStore in createPrerenderParamsForClientSegment'),
                '__NEXT_ERROR_CODE',
            ...
            if (c)
              switch (c.type) {
                ...
                case 'prerender-client':
                  ...
                  if (d) {
                    for (let e in a) if (d.has(e)) return F(c.renderSignal, b.route, '`params`');
                  }
                  break;
                case 'validation-client':
                  throw Object.defineProperty(
    ...
    function ad(a, b, c, { trailingSlash: d }) {
      var e, f;
      a = 'string' == typeof (e = a) && e.startsWith('./') ? $.default.posix.resolve(c, e) : e;
      let g = '',
        h = b ? ab(a, b) : a;
      if (
        ((g =
        ...
        if (!a) {
          try {
            let a = new URL(g);
            (d = null != b && a.origin !== b.origin), (f = a.pathname), (e = ac.test(f));
          } catch {
            d = !0;
          }
          if (!e && !d && !c) return `${g}/`;
    ...
    let ai = ['authors', 'tags'],
      ...
      al = ['emails', 'phoneNumbers', 'faxNumbers', 'alternateLocale', 'audio', 'videos'];
    function am(a, b, c) {
      let d = Z(a);
      if (!d) return d;
      let e = [];
      for (let a of d) {
        let d = (function (a, b, c) {
          ...
          if ('string' == typeof e && !(0, ag.isFullStringUrl)(e) && (!b || c)) {
            let a = (function (a) {
              let b,
                c,
                d = aa(),
    ...
    let an = {
      ...
      ao = async (a, b, c, d, e) => {
        ...
        for (let b of (f = a && 'type' in a ? a.type : void 0) && f in an ? an[f].concat(al) : al)
          if (b in a && 'url' !== b) {
            let c = a[b];
            g[b] = c ? Y(c) : null;
          }
    ...
    async function ax(a, b, c, d) {
      return a
        ? { url: au('string' == typeof a || a instanceof URL ? a : a.url, b, await c, d) }
        : null;
    }
    let ay = async (a, b, c, d) => {
      ...
      aB = (a) =>
        a ? { basic: aA(a), googleBot: 'string' != typeof a ? aA(a.googleBot) : null } : null,
      ...
      aG = async (a, b, c, d) =>
        a
          ? {
              appId: a.appId,
              appArgument: a.appArgument ? au(a.appArgument, b, await c, d) : void 0,
            }
          : null,
      aH = (a) => (a ? { appId: a.appId, admins: Z(a.admins) } : null),
      aI = async (a, b, c, d) => ({
        previous: (null == a ? void 0 : a.previous) ? au(a.previous, b, await c, d) : null,
    ...
    async function aT(
      ...
      let j = structuredClone(d),
        k = aR((null == c ? void 0 : c.metadataBase) !== void 0 ? c.metadataBase : d.metadataBase);
      for (let d in c)
        switch (d) {
          case 'title':
...
Read more: https://nextjs.org/docs/app/api-reference/functions/generate-viewport`);
    ...
    async function aX(a, b, c) {
      ...
      return (null == d ? void 0 : d.length) > 0 ? (await Promise.all(d)).flat() : void 0;
    }
    ...
    async function a2(a, b, c, d, e, f, g, h, i, j) {
      ...
      let r =
          ...
          (null === i[q.paramName] || void 0 === i[q.paramName])
            ...
            : e,
        s = R(p, r, j);
      for (let c in ((k = void 0 !== n ? { params: s, searchParams: f } : { params: s }),
      await a$({
        tree: b,
        viewportItems: a,
    ...
    async function a8(a, b, c, d) {
      ...
      return (function (a, b, c, d) {
        ...
        if (e) {
          ...
          if (
            (!g &&
              (a3(e.title) ? (b.title = e.title) : a.title && a3(a.title) && (b.title = a.title)),
    ...
    let bd = new Set(Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 }));
    function be(a) {
      ...
      return (0, W.jsx)(W.Fragment, {
        children: (function (a) {
          ...
          if (
            ...
            a.description &&
              g.push((0, W.jsx)('meta', { name: 'description', content: a.description }, h++)),
            a.applicationName &&
              g.push(
                (0, W.jsx)('meta', { name: 'application-name', content: a.applicationName }, h++)
              ),
            a.authors)
          )
            for (let b of a.authors)
              b.url && g.push((0, W.jsx)('link', { rel: 'author', href: b.url.toString() }, h++)),
                b.name && g.push((0, W.jsx)('meta', { name: 'author', content: b.name }, h++));
          if (a.manifest) {
            let b = (function (a) {
              let b;
              if ('string' == typeof a)
            ...
            g.push(
              (0, W.jsx)(
                'link',
                {
                  ...
                  crossOrigin:
                    b || 'preview' !== process.env.VERCEL_ENV ? void 0 : 'use-credentials',
                },
                h++
              )
            );
          ...
          if (
            (a.generator &&
              g.push((0, W.jsx)('meta', { name: 'generator', content: a.generator }, h++)),
            a.keywords &&
              a.keywords.length &&
              g.push((0, W.jsx)('meta', { name: 'keywords', content: a.keywords.join(',') }, h++)),
            a.referrer &&
              g.push((0, W.jsx)('meta', { name: 'referrer', content: a.referrer }, h++)),
            a.creator && g.push((0, W.jsx)('meta', { name: 'creator', content: a.creator }, h++)),
            a.publisher &&
              g.push((0, W.jsx)('meta', { name: 'publisher', content: a.publisher }, h++)),
            (null == (b = a.robots) ? void 0 : b.basic) &&
              g.push((0, W.jsx)('meta', { name: 'robots', content: a.robots.basic }, h++)),
            (null == (c = a.robots) ? void 0 : c.googleBot) &&
              g.push((0, W.jsx)('meta', { name: 'googlebot', content: a.robots.googleBot }, h++)),
            a.abstract &&
              g.push((0, W.jsx)('meta', { name: 'abstract', content: a.abstract }, h++)),
            a.archives)
          )
            for (let b of a.archives) g.push((0, W.jsx)('link', { rel: 'archives', href: b }, h++));
          if (a.assets)
            for (let b of a.assets) g.push((0, W.jsx)('link', { rel: 'assets', href: b }, h++));
          if (a.bookmarks)
          ...
          if (
            (a.pagination &&
              (a.pagination.previous &&
                g.push((0, W.jsx)('link', { rel: 'prev', href: a.pagination.previous }, h++)),
              a.pagination.next &&
                g.push((0, W.jsx)('link', { rel: 'next', href: a.pagination.next }, h++))),
            a.category &&
              g.push((0, W.jsx)('meta', { name: 'category', content: a.category }, h++)),
            a.classification &&
              g.push(
                (0, W.jsx)('meta', { name: 'classification', content: a.classification }, h++)
              ),
            a.other)
          )
            for (let [b, c] of Object.entries(a.other))
              if (Array.isArray(c))
                for (let a of c)
                  null != a &&
                    '' !== a &&
                    g.push((0, W.jsx)('meta', { name: b, content: String(a) }, h++));
              else
                null != c &&
                  '' !== c &&
                  g.push((0, W.jsx)('meta', { name: b, content: String(c) }, h++));
          if (a.alternates) {
            let { canonical: b, languages: c, media: d, types: e } = a.alternates;
            if (
              (b &&
                b.url &&
                g.push(
          ...
          if (a.itunes) {
            let { appId: b, appArgument: c } = a.itunes,
              d = `app-id=${b}`;
            c && (d += `, app-argument=${c}`),
              g.push((0, W.jsx)('meta', { name: 'apple-itunes-app', content: d }, h++));
          }
          if (
            a.facebook &&
            (a.facebook.appId &&
              g.push((0, W.jsx)('meta', { property: 'fb:app_id', content: a.facebook.appId }, h++)),
            a.facebook.admins)
          )
            for (let b of a.facebook.admins)
              g.push((0, W.jsx)('meta', { property: 'fb:admins', content: b }, h++));
          if (
            (a.pinterest &&
              ...
              g.push(
                (0, W.jsx)(
                  'meta',
                  { property: 'pinterest-rich-pin', content: a.pinterest.richPin.toString() },
                  h++
                )
              ),
            a.formatDetection)
            ...
            for (let c of ['telephone', 'date', 'address', 'email', 'url'])
              !1 === a.formatDetection[c] && (b && (b += ', '), (b += `${c}=no`));
            b && g.push((0, W.jsx)('meta', { name: 'format-detection', content: b }, h++));
          }
          if (a.verification) {
            ...
            if (b.yahoo)
              for (let a of b.yahoo)
                null != a &&
                  '' !== a &&
                  g.push((0, W.jsx)('meta', { name: 'y_key', content: String(a) }, h++));
            if (b.yandex)
              for (let a of b.yandex)
                null != a &&
                  '' !== a &&
                  g.push(
                    (0, W.jsx)('meta', { name: 'yandex-verification', content: String(a) }, h++)
                  );
            if (b.me)
              for (let a of b.me)
                null != a &&
                  '' !== a &&
                  g.push((0, W.jsx)('meta', { name: 'me', content: String(a) }, h++));
            if (b.other)
              for (let [a, c] of Object.entries(b.other))
                for (let b of c)
                  null != b &&
                    '' !== b &&
                    g.push((0, W.jsx)('meta', { name: a, content: String(b) }, h++));
          }
          if (a.appleWebApp) {
            let { capable: b, title: c, startupImage: d, statusBarStyle: e } = a.appleWebApp;
            if (
              (b &&
                g.push((0, W.jsx)('meta', { name: 'mobile-web-app-capable', content: 'yes' }, h++)),
              c &&
                g.push((0, W.jsx)('meta', { name: 'apple-mobile-web-app-title', content: c }, h++)),
              d)
            )
              for (let a of d)
                a.media
                  ? g.push(
                      (0, W.jsx)(
                        'link',
                        { href: a.url, media: a.media, rel: 'apple-touch-startup-image' },
                        h++
                      )
                    )
                  : g.push(
                      (0, W.jsx)('link', { href: a.url, rel: 'apple-touch-startup-image' }, h++)
                    );
            e &&
              g.push(
                (0, W.jsx)(
          ...
          if (a.openGraph) {
            ...
            if (
              (b.determiner &&
                g.push(
                  (0, W.jsx)('meta', { property: 'og:determiner', content: b.determiner }, h++)
                ),
              (null == (d = b.title) ? void 0 : d.absolute) &&
                g.push(
                  (0, W.jsx)('meta', { property: 'og:title', content: b.title.absolute }, h++)
                ),
              b.description &&
                g.push(
                  (0, W.jsx)('meta', { property: 'og:description', content: b.description }, h++)
                ),
              b.url &&
                g.push((0, W.jsx)('meta', { property: 'og:url', content: b.url.toString() }, h++)),
              b.siteName &&
                g.push((0, W.jsx)('meta', { property: 'og:site_name', content: b.siteName }, h++)),
              b.locale &&
                g.push((0, W.jsx)('meta', { property: 'og:locale', content: b.locale }, h++)),
              b.countryName &&
                g.push(
                  (0, W.jsx)('meta', { property: 'og:country_name', content: b.countryName }, h++)
                ),
              null != b.ttl &&
                g.push((0, W.jsx)('meta', { property: 'og:ttl', content: b.ttl.toString() }, h++)),
              b.images)
            )
              for (let a of b.images)
                'string' == typeof a
                  ? g.push((0, W.jsx)('meta', { property: 'og:image', content: a }, h++))
                  : (a.url &&
                      g.push(
                        (0, W.jsx)('meta', { property: 'og:image', content: String(a.url) }, h++)
                      ),
                    a.secureUrl &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'og:image:secure_url', content: String(a.secureUrl) },
                          h++
                        )
                      ),
                    a.type &&
                      g.push(
                        (0, W.jsx)('meta', { property: 'og:image:type', content: a.type }, h++)
                      ),
                    a.width &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'og:image:width', content: String(a.width) },
                          h++
                        )
                      ),
                    a.height &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'og:image:height', content: String(a.height) },
                          h++
                        )
                      ),
                    a.alt &&
                      g.push(
                        (0, W.jsx)('meta', { property: 'og:image:alt', content: a.alt }, h++)
                      ));
            if (b.videos)
              for (let a of b.videos)
                'string' == typeof a
                  ? g.push((0, W.jsx)('meta', { property: 'og:video', content: a }, h++))
                  : (a.url &&
                      g.push(
                        (0, W.jsx)('meta', { property: 'og:video', content: String(a.url) }, h++)
                      ),
                    a.secureUrl &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'og:video:secure_url', content: String(a.secureUrl) },
                          h++
                        )
                      ),
                    a.type &&
                      g.push(
                        (0, W.jsx)('meta', { property: 'og:video:type', content: a.type }, h++)
                      ),
                    a.width &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'og:video:width', content: String(a.width) },
                          h++
                        )
                      ),
                    a.height &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'og:video:height', content: String(a.height) },
                          h++
                        )
                      ));
            if (b.audio)
              for (let a of b.audio)
                'string' == typeof a
                  ? g.push((0, W.jsx)('meta', { property: 'og:audio', content: a }, h++))
                  : (a.url &&
                      g.push(
                        (0, W.jsx)('meta', { property: 'og:audio', content: String(a.url) }, h++)
                      ),
                    a.secureUrl &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'og:audio:secure_url', content: String(a.secureUrl) },
                          h++
                        )
                      ),
                    a.type &&
                      g.push(
                        (0, W.jsx)('meta', { property: 'og:audio:type', content: a.type }, h++)
                      ));
            if (b.emails)
              for (let a of b.emails)
                g.push((0, W.jsx)('meta', { property: 'og:email', content: a }, h++));
            if (b.phoneNumbers)
              for (let a of b.phoneNumbers)
                g.push((0, W.jsx)('meta', { property: 'og:phone_number', content: a }, h++));
            if (b.faxNumbers)
              for (let a of b.faxNumbers)
                g.push((0, W.jsx)('meta', { property: 'og:fax_number', content: a }, h++));
            if (b.alternateLocale)
              for (let a of b.alternateLocale)
                g.push((0, W.jsx)('meta', { property: 'og:locale:alternate', content: a }, h++));
            if ('type' in b) {
              let a = b.type;
              switch (a) {
                case 'website':
                  g.push((0, W.jsx)('meta', { property: 'og:type', content: 'website' }, h++));
                  break;
                case 'article':
                  if (
                    (g.push((0, W.jsx)('meta', { property: 'og:type', content: 'article' }, h++)),
                    b.publishedTime &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                    ...
                    b.modifiedTime &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'article:modified_time', content: b.modifiedTime.toString() },
                          h++
                        )
                      ),
                    b.expirationTime &&
                    ...
                    for (let a of b.authors)
                      g.push(
                        (0, W.jsx)('meta', { property: 'article:author', content: String(a) }, h++)
                      );
                  if (
                    (b.section &&
                      g.push(
                        (0, W.jsx)('meta', { property: 'article:section', content: b.section }, h++)
                      ),
                    b.tags)
                  )
                    for (let a of b.tags)
                      g.push((0, W.jsx)('meta', { property: 'article:tag', content: a }, h++));
                  break;
                case 'book':
                  if (
                    (g.push((0, W.jsx)('meta', { property: 'og:type', content: 'book' }, h++)),
                    b.isbn &&
                      g.push((0, W.jsx)('meta', { property: 'book:isbn', content: b.isbn }, h++)),
                    b.releaseDate &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'book:release_date', content: b.releaseDate },
                          h++
                        )
                      ),
                    b.authors)
                    ...
                    for (let a of b.authors)
                      g.push(
                        (0, W.jsx)('meta', { property: 'book:author', content: String(a) }, h++)
                      );
                  if (b.tags)
                    for (let a of b.tags)
                      g.push((0, W.jsx)('meta', { property: 'book:tag', content: a }, h++));
                  break;
                case 'profile':
                  g.push((0, W.jsx)('meta', { property: 'og:type', content: 'profile' }, h++)),
                    b.firstName &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'profile:first_name', content: b.firstName },
                          h++
                        )
                      ),
                    b.lastName &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'profile:last_name', content: b.lastName },
                          h++
                        )
                      ),
                    b.username &&
                    ...
                    b.gender &&
                      g.push(
                        (0, W.jsx)('meta', { property: 'profile:gender', content: b.gender }, h++)
                      );
                  break;
                case 'music.song':
                  if (
                    (g.push(
                      (0, W.jsx)('meta', { property: 'og:type', content: 'music.song' }, h++)
                    ),
                    null != b.duration &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'music:duration', content: b.duration.toString() },
                          h++
                        )
                      ),
                    b.albums)
                    ...
                    for (let a of b.albums)
                      'string' == typeof a
                        ? g.push((0, W.jsx)('meta', { property: 'music:album', content: a }, h++))
                        : (a.url &&
                            g.push(
                              (0, W.jsx)(
                                'meta',
                                { property: 'music:album', content: String(a.url) },
                                h++
                              )
                            ),
                          null != a.disc &&
                            g.push(
                              (0, W.jsx)(
                                'meta',
                                { property: 'music:album:disc', content: String(a.disc) },
                                h++
                              )
                            ),
                          null != a.track &&
                            g.push(
                              (0, W.jsx)(
                                'meta',
                                { property: 'music:album:track', content: String(a.track) },
                                h++
                              )
                            ));
                  if (b.musicians)
                    for (let a of b.musicians)
                      g.push(
                        (0, W.jsx)('meta', { property: 'music:musician', content: String(a) }, h++)
                      );
                  break;
                case 'music.album':
                  if (
                    (g.push(
                      (0, W.jsx)('meta', { property: 'og:type', content: 'music.album' }, h++)
                    ),
                    b.songs)
                  )
                    for (let a of b.songs)
                      'string' == typeof a
                        ? g.push((0, W.jsx)('meta', { property: 'music:song', content: a }, h++))
                        : (a.url &&
                            g.push(
                              (0, W.jsx)(
                                'meta',
                                { property: 'music:song', content: String(a.url) },
                                h++
                              )
                            ),
                          null != a.disc &&
                            g.push(
                              (0, W.jsx)(
                                'meta',
                                { property: 'music:song:disc', content: String(a.disc) },
                                h++
                              )
                            ),
                          null != a.track &&
                            g.push(
                              (0, W.jsx)(
                                'meta',
                                { property: 'music:song:track', content: String(a.track) },
                                h++
                              )
                            ));
                  if (b.musicians)
                  ...
                  b.releaseDate &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { property: 'music:release_date', content: b.releaseDate },
                        h++
                      )
                    );
                  break;
                case 'music.playlist':
                  if (
                    (g.push(
                      (0, W.jsx)('meta', { property: 'og:type', content: 'music.playlist' }, h++)
                    ),
                    b.songs)
                  )
                    for (let a of b.songs)
                  ...
                  if (b.creators)
                    for (let a of b.creators)
                      g.push(
                        (0, W.jsx)('meta', { property: 'music:creator', content: String(a) }, h++)
                      );
                  break;
                ...
                case 'video.movie':
                  if (
                    (g.push(
                      (0, W.jsx)('meta', { property: 'og:type', content: 'video.movie' }, h++)
                    ),
                    b.actors)
                  )
                    for (let a of b.actors)
                      'string' == typeof a
                        ? g.push((0, W.jsx)('meta', { property: 'video:actor', content: a }, h++))
                        : (a.url &&
                            g.push(
                              (0, W.jsx)(
                                'meta',
                                { property: 'video:actor', content: String(a.url) },
                                h++
                              )
                            ),
                          a.role &&
                            g.push(
                              (0, W.jsx)(
                                'meta',
                                { property: 'video:actor:role', content: a.role },
                                h++
                              )
                            ));
                  if (b.directors)
                    for (let a of b.directors)
                      g.push(
                        (0, W.jsx)('meta', { property: 'video:director', content: String(a) }, h++)
                      );
                  if (b.writers)
                    for (let a of b.writers)
                      g.push(
                        (0, W.jsx)('meta', { property: 'video:writer', content: String(a) }, h++)
                      );
                  if (
                    (null != b.duration &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'video:duration', content: String(b.duration) },
                          h++
                        )
                      ),
                    b.releaseDate &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { property: 'video:release_date', content: b.releaseDate },
                          h++
                        )
                      ),
                    b.tags)
                    ...
                    for (let a of b.tags)
                      g.push((0, W.jsx)('meta', { property: 'video:tag', content: a }, h++));
                  break;
                case 'video.episode':
                  if (
                    (g.push(
                      (0, W.jsx)('meta', { property: 'og:type', content: 'video.episode' }, h++)
                    ),
                    b.actors)
                  )
                    for (let a of b.actors)
                ...
                case 'video.tv_show':
                  g.push(
                    (0, W.jsx)('meta', { property: 'og:type', content: 'video.tv_show' }, h++)
                  );
                  break;
                case 'video.other':
                  g.push((0, W.jsx)('meta', { property: 'og:type', content: 'video.other' }, h++));
                  break;
                default:
                  throw Object.defineProperty(
          ...
          if (a.twitter) {
            let b = a.twitter,
              { card: c } = b;
            if (
              (c && g.push((0, W.jsx)('meta', { name: 'twitter:card', content: c }, h++)),
              b.site && g.push((0, W.jsx)('meta', { name: 'twitter:site', content: b.site }, h++)),
              b.siteId &&
                g.push((0, W.jsx)('meta', { name: 'twitter:site:id', content: b.siteId }, h++)),
              b.creator &&
                g.push((0, W.jsx)('meta', { name: 'twitter:creator', content: b.creator }, h++)),
              b.creatorId &&
                g.push(
                  (0, W.jsx)('meta', { name: 'twitter:creator:id', content: b.creatorId }, h++)
                ),
              (null == (e = b.title) ? void 0 : e.absolute) &&
                g.push(
                  (0, W.jsx)('meta', { name: 'twitter:title', content: b.title.absolute }, h++)
                ),
              b.description &&
                g.push(
                  (0, W.jsx)('meta', { name: 'twitter:description', content: b.description }, h++)
                ),
              b.images)
            )
              for (let a of b.images)
                'string' == typeof a
                  ? g.push((0, W.jsx)('meta', { name: 'twitter:image', content: a }, h++))
                  : (a.url &&
                      g.push(
                        (0, W.jsx)('meta', { name: 'twitter:image', content: String(a.url) }, h++)
                      ),
                    a.alt &&
                      g.push(
                        (0, W.jsx)('meta', { name: 'twitter:image:alt', content: a.alt }, h++)
                      ),
                    a.secureUrl &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { name: 'twitter:image:secure_url', content: String(a.secureUrl) },
                          h++
                        )
                      ),
                    a.type &&
                      g.push(
                        (0, W.jsx)('meta', { name: 'twitter:image:type', content: a.type }, h++)
                      ),
                    a.width &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { name: 'twitter:image:width', content: String(a.width) },
                          h++
                        )
                      ),
                    a.height &&
                      g.push(
                        (0, W.jsx)(
                          'meta',
                          { name: 'twitter:image:height', content: String(a.height) },
                          h++
                        )
                      ));
            if ('player' === c)
              for (let a of b.players)
                g.push(
                  ...
                  g.push(
                    (0, W.jsx)(
                      'meta',
                      { name: 'twitter:player:stream', content: a.streamUrl.toString() },
                      h++
                    )
                  ),
                  g.push(
                    (0, W.jsx)(
                      'meta',
                      { name: 'twitter:player:width', content: String(a.width) },
                      h++
                    )
                  ),
                  g.push(
                    (0, W.jsx)(
                      'meta',
                      { name: 'twitter:player:height', content: String(a.height) },
                      h++
                    )
                  );
            if ('app' === c) {
              ...
              for (let b of ['iphone', 'ipad', 'googleplay'])
                a.name &&
                  g.push(
                    (0, W.jsx)('meta', { name: `twitter:app:name:${b}`, content: a.name }, h++)
                  ),
                  a.id[b] &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { name: `twitter:app:id:${b}`, content: String(a.id[b]) },
                        h++
                      )
                    ),
                  (null == (f = a.url) ? void 0 : f[b]) &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { name: `twitter:app:url:${b}`, content: a.url[b].toString() },
                        h++
                      )
                    );
            }
          ...
          if (a.appLinks) {
            ...
            if (b.ios)
              for (let a of b.ios)
                a.url &&
                  g.push(
                    (0, W.jsx)('meta', { property: 'al:ios:url', content: String(a.url) }, h++)
                  ),
                  a.app_store_id &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { property: 'al:ios:app_store_id', content: String(a.app_store_id) },
                        h++
                      )
                    ),
                  a.app_name &&
                    g.push(
                      (0, W.jsx)('meta', { property: 'al:ios:app_name', content: a.app_name }, h++)
                    );
            if (b.iphone)
              for (let a of b.iphone)
                a.url &&
                  g.push(
                    (0, W.jsx)('meta', { property: 'al:iphone:url', content: String(a.url) }, h++)
                  ),
                  a.app_store_id &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { property: 'al:iphone:app_store_id', content: String(a.app_store_id) },
                        h++
                      )
                    ),
                  a.app_name &&
            ...
            if (b.ipad)
              for (let a of b.ipad)
                a.url &&
                  g.push(
                    (0, W.jsx)('meta', { property: 'al:ipad:url', content: String(a.url) }, h++)
                  ),
                  a.app_store_id &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { property: 'al:ipad:app_store_id', content: String(a.app_store_id) },
                        h++
                      )
                    ),
                  a.app_name &&
                    g.push(
                      (0, W.jsx)('meta', { property: 'al:ipad:app_name', content: a.app_name }, h++)
                    );
            if (b.android)
              for (let a of b.android)
                a.package &&
                  g.push(
                    (0, W.jsx)('meta', { property: 'al:android:package', content: a.package }, h++)
                  ),
                  a.url &&
                    g.push(
                      (0, W.jsx)(
                  ...
                  a.class &&
                    g.push(
                      (0, W.jsx)('meta', { property: 'al:android:class', content: a.class }, h++)
                    ),
                  a.app_name &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { property: 'al:android:app_name', content: a.app_name },
                        h++
                      )
                    );
            if (b.windows_phone)
              for (let a of b.windows_phone)
                a.url &&
                  g.push(
                    (0, W.jsx)(
                      'meta',
                      { property: 'al:windows_phone:url', content: String(a.url) },
                      h++
                    )
                  ),
                  a.app_id &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { property: 'al:windows_phone:app_id', content: a.app_id },
                        h++
                      )
                    ),
                  a.app_name &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { property: 'al:windows_phone:app_name', content: a.app_name },
                        h++
                      )
                    );
            if (b.windows)
              for (let a of b.windows)
                a.url &&
                  g.push(
                    (0, W.jsx)('meta', { property: 'al:windows:url', content: String(a.url) }, h++)
                  ),
                  a.app_id &&
                    g.push(
                      (0, W.jsx)('meta', { property: 'al:windows:app_id', content: a.app_id }, h++)
                    ),
                  a.app_name &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { property: 'al:windows:app_name', content: a.app_name },
                        h++
                      )
                    );
              ...
              for (let a of b.windows_universal)
                a.url &&
                  g.push(
                    (0, W.jsx)(
                      'meta',
                      { property: 'al:windows_universal:url', content: String(a.url) },
                      h++
                    )
                  ),
                  a.app_id &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { property: 'al:windows_universal:app_id', content: a.app_id },
                        h++
                      )
                    ),
                  a.app_name &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { property: 'al:windows_universal:app_name', content: a.app_name },
                        h++
                      )
                    );
            if (b.web)
              for (let a of b.web)
                a.url &&
                  g.push(
                    (0, W.jsx)('meta', { property: 'al:web:url', content: String(a.url) }, h++)
                  ),
                  null != a.should_fallback &&
                    g.push(
                      (0, W.jsx)(
                        'meta',
                        { property: 'al:web:should_fallback', content: String(a.should_fallback) },
                        h++
                      )
                    );
          }
          if (a.icons) {
            ...
            if (b)
              for (let a of b) {
                let { url: b, rel: c, ...d } = a;
                g.push(
                  (0, W.jsx)('link', { rel: c || 'shortcut icon', href: b.toString(), ...d }, h++)
                );
              }
            if (c)
              for (let a of c) {
                let { url: b, rel: c, ...d } = a;
                g.push((0, W.jsx)('link', { rel: c || 'icon', href: b.toString(), ...d }, h++));
              }
            if (d)
              for (let a of d) {
                let { url: b, rel: c, ...d } = a;
      ...
      return (0, W.jsx)(W.Fragment, {
        children: (function (a) {
          ...
          if (
            ...
            null != a.userScalable && d.push(`user-scalable=${a.userScalable ? 'yes' : 'no'}`),
            a.viewportFit && d.push(`viewport-fit=${a.viewportFit}`),
            a.interactiveWidget && d.push(`interactive-widget=${a.interactiveWidget}`),
            d.length &&
              b.push((0, W.jsx)('meta', { name: 'viewport', content: d.join(', ') }, c++)),
            a.themeColor)
          )
            for (let d of a.themeColor)
              d.media
                ...
                : b.push((0, W.jsx)('meta', { name: 'theme-color', content: d.color }, c++));
          return (
            a.colorScheme &&
              b.push((0, W.jsx)('meta', { name: 'color-scheme', content: a.colorScheme }, c++)),
            b
          );
        })(f),
      });
        ...
        function ({
                    ...
                    return (function (a, b, c) {
                      switch (c.type) {
                        case 'prerender': {
                          ...
                          if (a && a.size > 0) return F(c.renderSignal, b.route, '`pathname`');
                          break;
                        }
                        case 'prerender-ppr': {
                          let a = c.fallbackRouteParams;
                          if (a && a.size > 0) {
                            ...
                            return (
                              ...
                              (f.then = (b, c) => {
                                if (a)
                                  try {
                                    x(d.route, 'metadata relative url resolving', e);
                                  } catch (b) {
                                    a(b), (a = null);
                                  }
                                return g(b, c);
                  ...
                  case 'prerender-runtime':
                    return (function (a, b) {
                      ...
                      return c
                        ? c
                            .waitForStage(
                              c.currentStage === C.EarlyStatic || c.currentStage === C.EarlyRuntime
                                ? C.EarlyRuntime
                                : C.Runtime
                            )
                            .then(() => b)
          ...
          async function o() {
            ...
            return await bk(a, m, i, e, d, h, f).catch((b) => {
              if (bh(b)) throw b;
              return !f && be(b) ? bm(a, m, i, e, d, h).catch(() => null) : null;
            });
          }
          function p() {
            let b = Promise.all([bk(a, m, i, e, d, h, f), bo(a, i, e, h, f)]).then(() => null);
            return g
              ? (0, W.jsx)(bi.OutletBoundary, {
                  children: (0, W.jsx)(j.Suspense, { name: 'Next.MetadataOutlet', children: b }),
                })
          ...
          return (
            ...
            {
              Viewport: function () {
                return (0, W.jsx)(bi.ViewportBoundary, { children: (0, W.jsx)(n, {}) });
              },
              Metadata: function () {
                return g
                  ? (0, W.jsx)('div', {
                  ...
                  : (0, W.jsx)(bi.MetadataBoundary, { children: (0, W.jsx)(o, {}) });
              },
              MetadataOutlet: p,
            }
          );
...
Original Message: ${d}`);
        ...
        })(a, (null == b ? void 0 : b.route) ?? 'unknown route', bJ.SegmentCollection);
      }
    }
    function bL(a) {
      let b = a.f;
      return 1 !== b.length && 3 !== b[0].length
        ? (console.error(
          ...
          null)
        : { buildId: a.b, flightRouterState: b[0][0], seedData: b[0][1], head: b[0][2] };
    }
    async function bM(a, b, e, f, g, h, j) {
      ...
      let q = !1;
      for (let [a, b] of await Promise.all(n)) k.set(a, b), a.endsWith('__PAGE__') && (q = !0);
      return q || k.set('/todo-remove-fake-segment/__PAGE__', Buffer.alloc(0)), k;
    }
    async function bN(a, b, c, e, f, g) {
      ...
      let h = await (0, by.createFromReadableStream)(bV((0, bz.streamFromBuffer)(a)), {
          findSourceMapURL: d,
          serverConsumerManifest: e,
        }),
        i = bL(h);
    ...
    async function bQ({
      ...
      let k = await (0, by.createFromReadableStream)(bV((0, bz.streamFromBuffer)(b)), {
          findSourceMapURL: d,
          serverConsumerManifest: c,
        }),
        l = bL(k);
      ...
      let { buildId: m, flightRouterState: n, seedData: o, head: p } = l,
        ...
        s = (function a(b, c, d, e, f, g, h, i, j, k) {
          ...
          j ||
            (null !== f &&
              i.push((0, bA.waitAtLeastOneReactRenderTask)().then(() => bR(d, e, f[0], h, s, g))));
          let t = c[0];
          return (
            'string' == typeof t
              ? ((l = t), (m = null))
              : ((l = t[0]), (m = { type: t[2], key: b ? null : t[1], siblings: t[3] })),
            { name: l, param: m, prefetchHints: q, slots: n }
          );
        })(a, n, m, f, o, e, '', g, i, j);
      i
        ? g.push((0, bA.waitAtLeastOneReactRenderTask)().then(() => bS(n, m, f, o, p, r, e)))
        : g.push((0, bA.waitAtLeastOneReactRenderTask)().then(() => bR(m, f, p, bB, r, e))),
        h();
      let t = { tree: s, staleTime: f };
      return m && (t.buildId = m), t;
    }
    async function bR(a, b, d, e, f, g) {
      let h = { rsc: d, isPartial: await bU(d, g), staleTime: b, varyParams: f };
      a && (h.buildId = a);
    ...
    async function bT(a, b, c, d, e) {
      ...
      let i = null !== d ? d[0] : null,
        j = null !== d ? d[4] : null,
        k = null !== j ? bw(j) : null,
        l = { rsc: i, isPartial: null === i || (await bU(i, e)), staleTime: c, varyParams: k };
    ...
    async function bU(a, b) {
      ...
      return (
        ...
        await (0, i.prerender)(a, b, { filterStackFrame: c, signal: e.signal, onError() {} }),
        d
      );
    }
    function bV(a) {
    ...
    a.s(['collectPrefetchHints', 0, bN, 'collectSegmentData', 0, bM], 34373);
    var bW = a.i(21751);
    let bX = () => {};
    function bY(a) {
    ...
    globalThis.FinalizationRegistry &&
      (b = new FinalizationRegistry((a) => {
        let b = a.deref();
        b && !b.locked && b.cancel('Response object has been garbage collected').then(bX);
      }));
    ...
    async function b3(a, b, c, d, e, f) {
      ...
      return (
        c && (await d.set(b, { kind: b$.CachedRouteKind.FETCH, data: h, revalidate: e }, c)),
        await f(),
      ...
      let [k, l] = bY(b),
        m = k
          ...
          .then(async (a) => {
            ...
            null == f || f.set(c, h),
              d && (await e.set(c, { kind: b$.CachedRouteKind.FETCH, data: h, revalidate: g }, d));
          })
          .catch((a) => {
            (null == j ? void 0 : j.aborted) || console.warn('Failed to set fetch cache', h, a);
          })
          .finally(i),
        n = `cache-set-${c}`,
              ...
              let d =
                ...
                function (a, d) {
                  ...
                  if ('string' != typeof a || d) {
                    ...
                    (c = Array.from(g.headers.entries()).filter(([a]) => !bZ.has(a.toLowerCase()))),
                      (f = JSON.stringify([
                        g.method,
                        c,
                        g.mode,
              ...
              globalThis.fetch = (function (a, { workAsyncStorage: b, workUnitAsyncStorage: c }) {
                let d = async function (d, e) {
                  ...
                  let i = (null == h ? void 0 : h.href) ?? '',
                    j = (null == e || null == (f = e.method) ? void 0 : f.toUpperCase()) || 'GET',
                    k = (null == e || null == (g = e.next) ? void 0 : g.internal) === !0,
                  ...
                  let r = (0, aM.getTracer)().trace(
                    k ? aN.NextNodeServerSpan.internalFetch : aN.AppRenderSpan.fetch,
                    {
                      hideSpan: m,
                    ...
                    async () => {
                        ...
                        w = (function (a, b) {
                          ...
                          for (let e = 0; e < a.length; e++) {
                            ...
                            if ('string' != typeof f)
                              ...
                              c.push(b_.test(f) ? f.replace(b0, (a) => encodeURIComponent(a)) : f);
                      ...
                      'force-cache' === A && void 0 === u ? (u = !1) : (C || D) && (u = 0),
                        ('no-cache' === A || 'no-store' === A) && (B = `cache: ${A}`),
                        (l = (function (a, b) {
                          try {
                            let c;
                      ...
                      let E = r('headers'),
                        ...
                        I = !['get', 'head'].includes(
                          (null == (b = r('method')) ? void 0 : b.toLowerCase()) || 'get'
                        ),
                        J = void 0 == y && (void 0 == A || 'default' === A) && void 0 == u,
                      ...
                      if (
                        ...
                        switch (p.type) {
                          ...
                          case 'prerender-client':
                            return (
                              q && (q.endRead(), (q = null)), F(p.renderSignal, o.route, 'fetch()')
                            );
                        }
                      switch (y) {
                        case 'force-no-store':
                        ...
                        case 'force-cache':
                          (void 0 === u || 0 === u) &&
                            ((B = 'fetchCache = force-cache'), (l = bW.INFINITE_CACHE));
                      }
                      if (
                        (void 0 === l
                          ? 'default-cache' !== y || z
                            ? 'default-no-store' === y
                              ...
                              : K
                              ? ((l = 0), (B = 'auto no cache'))
                              : ((B = 'auto cache'), (l = c ? c.revalidate : bW.INFINITE_CACHE))
                            : ((l = bW.INFINITE_CACHE), (B = 'fetchCache = default-cache'))
                          : B || (B = `revalidate: ${l}`),
                        !(o.forceStatic && 0 === l) && !K && c && l < c.revalidate)
                      ) {
                        if (0 === l) {
                          if (p)
                            switch (p.type) {
                          ...
                          return a(d, k)
                            .then(async (a) => {
                              if (
                                ...
                                let b = l >= bW.INFINITE_CACHE ? bW.CACHE_ONE_YEAR_SECONDS : l,
                                  c = M
                                    ? {
                                        fetchCache: !0,
                                        fetchUrl: i,
                                ...
                                switch (null == p ? void 0 : p.type) {
                                  ...
                                  case 'generate-static-params':
                                  case void 0:
                                    return b4(o, a, g, c, N, h, b, d, Q, r('signal'));
                                }
                              }
                              return await Q(), a;
                            })
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0g84hko._.js.map
