(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    var E = (O.prototype = new S());
    (E.constructor = O), m(E, x.prototype), (E.isPureReactComponent = !0);
    var j = Array.isArray;
    function T() {}
    ...
    function P(e, t, r) {
      ...
      return (
        !(function e(t, r, n, u, s) {
          ...
          var p = '' === u ? '.' : u + ':';
          if (j(t))
            for (var g = 0; g < t.length; g++) (f = p + H((u = t[g]), g)), (d += e(u, r, n, f, s));
          else if (
            'function' ==
            typeof (g =
            ...
            for (t = g.call(t), g = 0; !(u = t.next()).done; )
              (f = p + H((u = u.value), g++)), (d += e(u, r, n, f, s));
          else if ('object' === f) {
    ...
    function L(e) {
      ...
      try {
        var n = e(),
          o = w.S;
        null !== o && o(r, n),
          'object' == typeof n && null !== n && 'function' == typeof n.then && n.then(T, M);
      } catch (e) {
        M(e);
      } finally {
